...
view: events_20210518 {
  sql_table_name: `logcomex-analytics.analytics_266726910.events_20210518`
    ;;
...
view: events_20210518__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210518__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
