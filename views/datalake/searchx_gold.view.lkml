view: searchx_gold {
  ...
  measure: val_fob_us_subitem {
    type: sum
    sql: ${TABLE}.val_fob_us_subitem ;;
  }

  measure: val_frete_un_us {
    type: sum
    sql: ${TABLE}.val_frete_un_us ;;
  }

  measure: val_frete_us {
    type: sum
  ...
  measure: val_peso_liq_subitem {
    type: sum
    sql: ${TABLE}.val_peso_liq_subitem ;;
  }

  measure: val_seg_un_us {
    type: sum
  ...
  measure: val_tot_unid_prod_us {
    type: sum
    sql: ${TABLE}.val_tot_unid_prod_us ;;
  }

  measure: val_unid_prod_us {
    type: sum
    sql: ${TABLE}.val_unid_prod_us ;;
  }

  measure: val_vmld_us_subitem {
    type: sum
