- dashboard: viso_de_mercado_unificado__valor_fob
  ...
  - title: Quantidade Total de Itens Importados
    ...
    explore: search_estrutura_atrib_st
    type: single_value
    fields: [search_estrutura_atrib_st.count]
    limit: 500
    custom_color_enabled: true
    show_single_value_title: true
    show_comparison: false
  ...
  - title: Valor FOB Total (US$) - Tendência Mensal
    ...
    explore: search_estrutura_atrib_st
    type: looker_column
    fields: [search_estrutura_atrib_st.fob_sum, search_estrutura_atrib_st.count, search_estrutura_atrib_st.anomes_norm,
      search_estrutura_atrib_st.anomes]
    ...
    rows_font_size: 12
    defaults_version: 1
    hidden_fields: [search_estrutura_atrib_st.fob_sum, search_estrutura_atrib_st.count,
      search_estrutura_atrib_st.anomes]
    listen:
      NCM: search_estrutura_atrib_st.cdncm_compl
      Produto: search_estrutura_atrib_st.produto
  ...
  - title: Valor FOB Total (US$) - Ranking Importadores
    ...
    explore: search_estrutura_atrib_st
    type: looker_column
    fields: [search_estrutura_atrib_st.fob_sum, search_estrutura_atrib_st.count, search_estrutura_atrib_st.importador_nome]
    filters:
  ...
  - title: NCMs Importados
    ...
    fields: [search_estrutura_atrib_st.ncm_desc, search_estrutura_atrib_st.fob_sum,
      search_estrutura_atrib_st.count]
    sorts: [search_estrutura_atrib_st.fob_sum desc]
    limit: 500
    show_view_names: false
    show_row_numbers: true
    ...
    series_labels:
      search_estrutura_atrib_st.count: Quantidade de Registros
  ...
  - title: País de Origem
    ...
    explore: search_estrutura_atrib_st
    type: looker_map
    fields: [search_estrutura_atrib_st.fob_sum, search_estrutura_atrib_st.store_location]
    sorts: [search_estrutura_atrib_st.fob_sum]
    limit: 500
  ...
  - title: Valor FOB Total (US$) - Modal
    ...
    explore: search_estrutura_atrib_st
    type: looker_pie
    fields: [search_estrutura_atrib_st.fob_sum, search_estrutura_atrib_st.via_transp_norm]
    filters:
  ...
  - title: Valor FOB Total (US$) - Ranking Exportadores
    ...
    explore: search_estrutura_atrib_st
    type: looker_column
    fields: [search_estrutura_atrib_st.fob_sum, search_estrutura_atrib_st.count, search_estrutura_atrib_st.exportador_nome]
    filters:
  ...
  - title: Valor FOB Total (US$) - Tamanho
    ...
    explore: search_estrutura_atrib_st
    type: looker_column
    fields: [search_estrutura_atrib_st.fob_sum, search_estrutura_atrib_st.tamanho]
    filters:
    ...
    dynamic_fields: [{table_calculation: calculation_1, label: Calculation 1, expression: "${search_estrutura_atrib_st.fob_sum}",
        ...
        expression: "${search_estrutura_atrib_st.fob_sum}/sum(${search_estrutura_atrib_st.fob_sum})",
    ...
    label_color: ["#7a7a7a"]
    defaults_version: 1
    hidden_fields: [search_estrutura_atrib_st.fob_sum, calculation_1]
    note_state: collapsed
    note_display: hover
  ...
  - title: Valor FOB Total (US$) - Ranking Modelos
    ...
    explore: search_estrutura_atrib_st
    type: looker_column
    fields: [search_estrutura_atrib_st.fob_sum, search_estrutura_atrib_st.count, search_estrutura_atrib_st.modelo]
    filters:
  ...
  - title: Valor FOB Total (US$) - Material
    ...
    explore: search_estrutura_atrib_st
    type: looker_column
    fields: [search_estrutura_atrib_st.fob_sum, search_estrutura_atrib_st.material]
    filters:
    ...
    label_color: ["#7a7a7a"]
    defaults_version: 1
    hidden_fields: [search_estrutura_atrib_st.fob_sum, percent_of_total]
    listen:
      NCM: search_estrutura_atrib_st.cdncm_compl
      Produto: search_estrutura_atrib_st.produto
      Modal: search_estrutura_atrib_st.via_transp_norm
  ...
  - title: Valor FOB Total (US$) - Gênero
    ...
    explore: search_estrutura_atrib_st
    type: looker_pie
    fields: [search_estrutura_atrib_st.fob_sum, search_estrutura_atrib_st.genero]
    filters:
  ...
  - title: Valor FOB Total (US$) - Ranking Marcas
    ...
    explore: search_estrutura_atrib_st
    type: looker_column
    fields: [search_estrutura_atrib_st.fob_sum, search_estrutura_atrib_st.marca]
    filters:
