- dashboard: st_importacoes_fase01_unificado
  title: Visão de Mercado - Unificado
  layout: newspaper
  ...
  - title: Valor FOB Total (US$) - Tendência Mensal
    ...
    explore: search_estrutura_atrib_st
    type: looker_column
    fields: [search_estrutura_atrib_st.fob_sum, search_estrutura_atrib_st.count,
      search_estrutura_atrib_st.anomes_norm, search_estrutura_atrib_st.anomes]
  ...
  - title: Valor FOB Total (US$) - Ranking Importadores
    ...
    type: looker_column
    fields: [search_estrutura_atrib_st.fob_sum, search_estrutura_atrib_st.count,
      search_estrutura_atrib_st.importador_nome]
    filters:
  ...
  - title: Valor FOB Total (US$) - Ranking Exportadores
    ...
    type: looker_column
    fields: [search_estrutura_atrib_st.fob_sum, search_estrutura_atrib_st.count,
      search_estrutura_atrib_st.exportador_nome]
    filters:
  ...
  - title: Valor FOB Total (US$) - Ranking Modelos
    ...
    type: looker_column
    fields: [search_estrutura_atrib_st.fob_sum, search_estrutura_atrib_st.count,
      search_estrutura_atrib_st.modelo]
    filters:
