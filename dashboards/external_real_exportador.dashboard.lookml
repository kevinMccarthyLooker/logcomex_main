- dashboard: real_exportador
  ...
  - title: Real Exportador
    ...
    type: looker_grid
    fields: [big_data_expo_real_exportador.count_mar_id, big_data_expo_real_exportador.nf_nome_emissor]
    filters: {}
    ...
    listen:
      ...
      Real Exportador: big_data_expo_real_exportador.nf_nome_emissor_2
