- dashboard: martimo
  ...
  - title: Valor de Multa
    ...
    width: 5
    height: 2
  - title: Registro por URF
    name: Registro por URF
    model: Comex_Analytics
    explore: comex_analytics_di
    type: looker_grid
    fields: [comex_analytics_di.importador_nome, comex_analytics_di.urf_despacho,
      comex_analytics_di.urf_entrada_carga, comex_analytics_di.importador_cnpj, comex_analytics_di.di_total]
    filters:
      comex_analytics_di.via_transp: MARÍTIMA,MARíTIMA
    sorts: [comex_analytics_di.di_total desc]
    limit: 500
  ...
  - title: DI por despachante
    ...
    fields: [comex_analytics_di.nome_representante, comex_analytics_di.importador_nome,
      comex_analytics_di.di_total, comex_analytics_di.importador_cnpj]
    filters:
      comex_analytics_di.via_transp: MARÍTIMA,MARíTIMA
    sorts: [comex_analytics_di.di_total desc]
    limit: 500
  ...
  - title: Frete em USD
    ...
    height: 2
  - title: Consulta de Canal
    name: Consulta de Canal (2)
    model: Comex_Analytics
    explore: comex_analytics_di
    type: looker_grid
    fields: [comex_analytics_di.canal, comex_analytics_di.di_total, comex_analytics_di.importador_cnpj,
      comex_analytics_di.importador_nome]
    filters:
      comex_analytics_di.via_transp: MARÍTIMA,MARíTIMA
      comex_analytics_di.data_hora_registro: NOT NULL
  ...
  - title: Presença x Desembaraço
    ...
    width: 12
    height: 2
  - title: Presença x Registro
    name: Presença x Registro
    model: Comex_Analytics
    explore: comex_analytics_di
    type: single_value
    ...
    dynamic_fields: [{based_on: comex_analytics_di.days_presenca_x_desembaraco, _kind_hint: measure,
        measure: sum_of_days_presenca_x_desembaraco, type: average, _type_hint: number,
        category: measure, expression: '', label: Sum of Days Presenca X Desembaraco},
      {measure: average_of_days_presenca_x_registro, based_on: comex_analytics_di.days_presenca_x_registro,
        expression: '', label: Average of Days Presenca X Registro, type: average,
