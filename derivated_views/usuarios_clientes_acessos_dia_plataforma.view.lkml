  ...
  derived_table: {
    ...
    from
      (
        ...
        inner JOIN (select (current_date - interval '91' day) + (interval '1' day * generate_series(0,91)) as dia) as dias on 1 = 1
        where (date(dias.dia) between (date(customer_plan."start")) and date((customer_plan."expiration")))
          ...
          and dia >= current_date - interval '91' day
        ...
        and al.created_at >= current_date - interval '91 days'
