view: big_data_filtros {
  ...
  dimension: campo_produto {
    type: string
    sql:  case
          when ${filter} = 'end_date' and ${service} = 'Exportação' then 'Data final'
          when ${filter} = 'start_date' and ${service} = 'Exportação' then 'Data inicial'
          when ${filter} = 'txshipper' and ${service} = 'Exportação'  then 'Nome exportador'
          when ${filter} = 'sub_grouper' and ${service} = 'Exportação' then 'Sub agrupador'
          when ${filter} = 'oprecolhimentofrete' and ${service} = 'Exportação' then 'Tipo de pagamento'
          when ${filter} = 'nmportoorigem' and ${service} = 'Exportação' then 'Porto origem'
          when ${filter} = 'nmportodestino' and ${service} = 'Exportação' then 'Porto destino'
          when ${filter} = 'itemcarga_cdncms' and ${service} = 'Exportação' then 'HSCODE'
          when ${filter} = 'tipo_carga' and ${service} = 'Exportação' then 'Tipo carga'
          when ${filter} = 'nmpaisdestfinal' and ${service} = 'Exportação' then 'País destino'
          when ${filter} = 'cdshipper' and ${service} = 'Exportação' then 'CNPJ shipper'
          when ${filter} = 'oprecolhimentofrete' and ${service} = 'Exportação' then 'Tipo pagamento'
          when ${filter} = 'cdconsignatario' and ${service} = 'Exportação' then 'CNPJ consignatário'
          when ${filter} = 'nmconsignatario' and ${service} = 'Exportação' then 'Nome consignatário'
          when ${filter} = 'itemcarga_noncms' and ${service} = 'Exportação' then 'Descrição mercadoria'
          when ${filter} = 'trade_lane_destino' and ${service} = 'Exportação' then 'Trade lane'
          when ${filter} = 'sub_grouper_value' and ${service} = 'Exportação' then 'Detalhes sub agrupador'
          when ${filter} = 'nmempresanavegacao' and ${service} = 'Exportação' then 'Armador'
          when ${filter} = 'tipoconhecimento' and ${service} = 'Exportação' then 'Tipo embarque'
          when ${filter} = 'nmterminalportuariocarregamento' and ${service} = 'Exportação' then 'Terminal embarque'
          when ${filter} = 'nmembarcacao' and ${service} = 'Exportação' then  'Navio'
          when ${filter} = 'trade_lane_origem' and ${service} = 'Exportação' then 'Trade lane de origem'
          when ${filter} = 'nmterminalportuario' and ${service} = 'Exportação' then 'Terminal de descarga'
          when ${filter} = 'txmercadoria' and ${service} = 'Exportação' then  'Descrição mercadoria - txmercadoria'
          when ${filter} = 'load_type' and ${service} = 'Exportação' then 'Tipo carga - load_type'
          when ${filter} = 'itemcarga_descricao' and ${service} = 'Exportação' then 'Descrição carga'
          when ${filter} = 'nmempnavegdesconmaster' and ${service} = 'Exportação' then 'Agente internacional'
          when ${filter} = 'armazem_destino' and and ${service} = 'Exportação' then 'Armazém de destino'
          when ${filter} = 'tipoconhecimentoexpo' and ${service} = 'Exportação' then  'Tipo embarque - tipoconhecimentoexpo'
          when ${filter} = 'nmpaisprocedencia' and ${service} = 'Exportação' then 'País procedência'
          when ${filter} = 'consignatario_cidade' and ${service} = 'Exportação' then 'Cidade consignatário'
          when ${filter} = 'consignatario_uf' and ${service} = 'Exportação' then 'UF consignatário'
          when ${filter} = 'notificado' and ${service} = 'Exportação' then 'Notificado'
